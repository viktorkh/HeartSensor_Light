...
try {
    ...
    _receiver.setAlarm(this,Integer.parseInt(duration));
}
catch (Exception ex){
    ...
    //    new SendToDataLayerThread("/message_path",duration,maxrate ).start();
        ...
        Toast.makeText(getApplicationContext(), "Sensor was started !!!",
    ...
    public void btnCancel_Click(View target) {
        ...
        Toast.makeText(getApplicationContext(), "Sensor was canceled !!!",
                Toast.LENGTH_SHORT).show();
        finish();
    }
